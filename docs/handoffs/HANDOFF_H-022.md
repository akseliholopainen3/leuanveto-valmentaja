...
>
> *Tila: **H-022 ARKISTOITU 23.8.2026** — A1–A6 valmiit, pushattu `5d0100f`. Samassa sessiossa toteutettiin myös H-021 (OBS-058, e1RM-evidenssisuodatin), joka ei kulkenut oman handoffin kautta — sen acceptance-evidenssi on commitissa `5d0100f`. Alkuperäinen tila: **AKTIIVINEN** — ratifioitu 23.8.2026. Lähde: `SYVATUTKIMUS_GAMMA` (Cowork 23.8.) + Coden PRE-FLIGHT/mittausraportti. Draft v3 siirretty tähän sellaisenaan; AC-tiedosto `docs/AC_H-022.md`.*
